...
namespace eosio {
   ...
   /**
    * eosio.token contract (with addition of `transferbyid`) defines the structures and actions that allow users to create, issue, and manage
    ...
    */
    class [[eosio::contract]] Token : public contract {
        public:
             ...
             */
            [[eosio::action]]
            void transferbyid(const name& from, const name& to, const name& amount_account, uint64_t amount_id, const string& memo);
