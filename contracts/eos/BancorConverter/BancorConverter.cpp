...
void BancorConverter::convert(name from, eosio::asset quantity, string memo, name code) {
...
void BancorConverter::verify_entry(name account, name currency_contract, asset currency) {
...
void BancorConverter::verify_min_return(asset quantity, string min_return) {
